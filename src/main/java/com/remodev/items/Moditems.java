...
public class Moditems {
    ...
    public static final Item KEVINIUM_PICKAXE = registerItem("kevinium_pickaxe", new Item(new FabricItemSettings()));
    public static final Item KEVINIUM_AXE = registerItem("kevinium_axe", new Item(new FabricItemSettings()));
    public static final Item KEVINIUM_SHOVEL = registerItem("kevinium_shovel", new Item(new FabricItemSettings()));
    public static final Item KEVINIUM_SWORD = registerItem("kevinium_sword", new Item(new FabricItemSettings()));
    public static final Item KEVINIUM_HOE = registerItem("kevinium_hoe", new Item(new FabricItemSettings()));
    public static final Item KEVINIUM_HAMMER = registerItem("kevinium_hammer", new Item(new FabricItemSettings()));
    public static final Item KEVINIUM_GREAT_AXE = registerItem("kevinium_great_axe", new Item(new FabricItemSettings()));
    ...
    public static final Item JUANITIUM_PICKAXE = registerItem("juanitium_pickaxe", new Item(new FabricItemSettings()));
    public static final Item JUANITIUM_AXE = registerItem("juanitium_axe", new Item(new FabricItemSettings()));
    public static final Item JUANITIUM_SHOVEL = registerItem("juanitium_shovel", new Item(new FabricItemSettings()));
    public static final Item JUANITIUM_SWORD = registerItem("juanitium_sword", new Item(new FabricItemSettings()));
    public static final Item JUANITIUM_HOE = registerItem("juanitium_hoe", new Item(new FabricItemSettings()));
    public static final Item JUANITIUM_HAMMER = registerItem("juanitium_hammer", new Item(new FabricItemSettings()));
    public static final Item JUANITIUM_GREAT_AXE = registerItem("juanitium_great_axe", new Item(new FabricItemSettings()));
    ...
    public static final Item LUKITE_PICKAXE = registerItem("lukite_pickaxe", new Item(new FabricItemSettings()));
    public static final Item LUKITE_AXE = registerItem("lukite_axe", new Item(new FabricItemSettings()));
    public static final Item LUKITE_SHOVEL = registerItem("lukite_shovel", new Item(new FabricItemSettings()));
    public static final Item LUKITE_SWORD = registerItem("lukite_sword", new Item(new FabricItemSettings()));
    public static final Item LUKITE_HOE = registerItem("lukite_hoe", new Item(new FabricItemSettings()));
    public static final Item LUKITE_HAMMER = registerItem("lukite_hammer", new Item(new FabricItemSettings()));
    public static final Item LUKITE_GREAT_AXE = registerItem("lukite_great_axe", new Item(new FabricItemSettings()));
    ...
    public static final Item SARITE_PICKAXE = registerItem("sarite_pickaxe", new Item(new FabricItemSettings()));
    public static final Item SARITE_AXE = registerItem("sarite_axe", new Item(new FabricItemSettings()));
    public static final Item SARITE_SHOVEL = registerItem("sarite_shovel", new Item(new FabricItemSettings()));
    public static final Item SARITE_SWORD = registerItem("sarite_sword", new Item(new FabricItemSettings()));
    public static final Item SARITE_HOE = registerItem("sarite_hoe", new Item(new FabricItemSettings()));
    public static final Item SARITE_HAMMER = registerItem("sarite_hammer", new Item(new FabricItemSettings()));
    public static final Item SARITE_GREAT_AXE = registerItem("sarite_great_axe", new Item(new FabricItemSettings()));
    ...
    public static final Item TOMINITE_PICKAXE = registerItem("tominite_pickaxe", new Item(new FabricItemSettings()));
    public static final Item TOMINITE_AXE = registerItem("tominite_axe", new Item(new FabricItemSettings()));
    public static final Item TOMINITE_SHOVEL = registerItem("tominite_shovel", new Item(new FabricItemSettings()));
    public static final Item TOMINITE_SWORD = registerItem("tominite_sword", new Item(new FabricItemSettings()));
    public static final Item TOMINITE_HOE = registerItem("tominite_hoe", new Item(new FabricItemSettings()));
    public static final Item TOMINITE_HAMMER = registerItem("tominite_hammer", new Item(new FabricItemSettings()));
    public static final Item TOMINITE_GREAT_AXE = registerItem("tominite_great_axe", new Item(new FabricItemSettings()));
